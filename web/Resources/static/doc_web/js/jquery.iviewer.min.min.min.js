...
"-moz-","-o-","-ms-"],function(a,b){c.css(b+"transform",d)});r&&(jQuery.each(["-ms-",""],function(b,d){c.css(d+"filter",n[a].filter)}),c.css({marginLeft:n[a].marginLeft*this.display_diff()/2,marginTop:n[a].marginTop*this.display_diff()/2}))},function(){return this._angle});this.toOriginalCoords=function(a){switch(this.angle()){case 0:return{x:a.x,y:a.y};case 90:return{x:a.y,y:this.display_width()-a.x};case 180:return{x:this.display_width()-a.x,y:this.display_height()-a.y};case 270:return{x:this.display_height()-
a.y,y:a.x}}};this.toRealCoords=function(a){switch(this.angle()){case 0:return{x:this.x()+a.x,y:this.y()+a.y};case 90:return{x:this.x()+this.display_width()-a.y,y:this.y()+a.x};case 180:return{x:this.x()+this.display_width()-a.x,y:this.y()+this.display_height()-a.y};case 270:return{x:this.x()+a.y,y:this.y()+this.display_height()-a.x}}};this.object=k(jQuery.noop,function(){return this._img});this.setImageProps=function(a,b,d,c,h,f){f=f||jQuery.noop;this.display_width(a);this.display_height(b);this.x(d,
!0);this.y(c,!0);a={width:this._swapDimensions?b:a,height:this._swapDimensions?a:b,top:c-(this._swapDimensions?this.display_diff()/2:0)+"px",left:d+(this._swapDimensions?this.display_diff()/2:0)+"px"};r&&jQuery.extend(a,{marginLeft:n[this.angle()].marginLeft*this.display_diff()/2,marginTop:n[this.angle()].marginTop*this.display_diff()/2});var g=this._swapDimensions,k=this._img;if(r&&g){var l=this._img.width(),m=this._img.height(),q=a.height-l;iedw=a.width-m;delete a.width;delete a.height}this._do_anim&&
!h?this._img.stop(!0).animate(a,{duration:200,complete:f,step:function(a,b){if(r&&g&&"top"===b.prop){var c=(a-b.start)/(b.end-b.start);k.height(l+q*c);k.width(m+iedw*c);k.css("top",a)}}}):(this._img.css(a),setTimeout(f,0))};this._finishAnimation=function(){this._img.stop(!0,!0)}}).apply(c.ui.iviewer.ImageObject.prototype);var h={scaleValue:function(a,b){return a*b/100},descaleValue:function(a,b){return 100*a/b}}})(jQuery,void 0);
